...
public class OrderMessagingDataMapper {
    ...
    public PaymentRequestAvroModel orderCreatedEventToPaymentRequestAvroModel(OrderCreatedEvent orderCreatedEvent) {
        OrderAggregate order = orderCreatedEvent.getOrder();
    ...
    public PaymentRequestAvroModel orderCancelledEventToPaymentRequestAvroModel(OrderCancelledEvent orderCancelledEvent) {
        OrderAggregate order = orderCancelledEvent.getOrder();
        return PaymentRequestAvroModel.newBuilder()
                .setId(UUID.randomUUID().toString())
                .setSagaId("")
                .setCustomerId(order.getCustomerId().getValue().toString())
    ...
    orderPaidEventToRestaurantApprovalRequestAvroModel(OrderPaidEvent orderPaidEvent) {
        OrderAggregate order = orderPaidEvent.getOrder();
    ...
    public PaymentResponse paymentResponseAvroModelToPaymentResponse(PaymentResponseAvroModel
        ...
        return PaymentResponse.builder()
                ...
                .paymentStatus(food.order.service.domain.valueobject.PaymentStatus.valueOf(
    ...
    approvalResponseAvroModelToApprovalResponse(RestaurantApprovalResponseAvroModel
        ...
        return RestaurantApprovalResponse.builder()
                ...
                .orderApprovalStatus(food.order.service.domain.valueobject.OrderApprovalStatus.valueOf(
