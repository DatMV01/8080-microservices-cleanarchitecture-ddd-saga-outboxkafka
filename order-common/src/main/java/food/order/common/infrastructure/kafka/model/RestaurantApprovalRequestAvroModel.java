...
public class RestaurantApprovalRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private food.order.common.infrastructure.kafka.model.RestaurantOrderStatus restaurantOrderStatus;
  private java.util.List<food.order.common.infrastructure.kafka.model.Product> products;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: restaurantOrderStatus = (food.order.common.infrastructure.kafka.model.RestaurantOrderStatus)value$; break;
    case 5: products = (java.util.List<food.order.common.infrastructure.kafka.model.Product>)value$; break;
   ...
   */
  public food.order.common.infrastructure.kafka.model.RestaurantOrderStatus getRestaurantOrderStatus() {
   ...
   * @param value the value to set.
   */
  public void setRestaurantOrderStatus(food.order.common.infrastructure.kafka.model.RestaurantOrderStatus value) {
   ...
   */
  public java.util.List<food.order.common.infrastructure.kafka.model.Product> getProducts() {
    return products;
  }
   ...
   * @param value the value to set.
   */
  public void setProducts(java.util.List<food.order.common.infrastructure.kafka.model.Product> value) {
    this.products = value;
  }
   ...
   */
  public static food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder newBuilder() {
    return new food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder();
  }
   ...
   * @return A new RestaurantApprovalRequestAvroModel RecordBuilder
   */
  public static food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder newBuilder(food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder other) {
    if (other == null) {
      return new food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder();
    } else {
      return new food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new RestaurantApprovalRequestAvroModel RecordBuilder
   */
  public static food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder newBuilder(food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel other) {
    if (other == null) {
      return new food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder();
    } else {
      return new food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder setRestaurantId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder clearRestaurantId() {
      restaurantId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder setRestaurantOrderStatus(food.order.common.infrastructure.kafka.model.RestaurantOrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder clearRestaurantOrderStatus() {
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder setProducts(java.util.List<food.order.common.infrastructure.kafka.model.Product> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder clearProducts() {
      products = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public food.order.common.infrastructure.kafka.model.RestaurantApprovalRequestAvroModel.Builder clearCreatedAt() {
    ...
    public RestaurantApprovalRequestAvroModel build() {
      try {
        ...
        record.restaurantOrderStatus = fieldSetFlags()[4] ? this.restaurantOrderStatus : (food.order.common.infrastructure.kafka.model.RestaurantOrderStatus) defaultValue(fields()[4]);
        record.products = fieldSetFlags()[5] ? this.products : (java.util.List<food.order.common.infrastructure.kafka.model.Product>) defaultValue(fields()[5]);
