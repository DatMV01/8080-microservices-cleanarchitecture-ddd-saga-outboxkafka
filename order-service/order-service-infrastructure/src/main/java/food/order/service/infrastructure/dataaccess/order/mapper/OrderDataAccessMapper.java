...
import food.order.service.infrastructure.dataaccess.order.entity.OrderAddressEntity;
import food.order.service.infrastructure.dataaccess.order.entity.OrderEntity;
import food.order.service.infrastructure.dataaccess.order.entity.OrderItemEntity;
...
import static food.order.service.domain.aggregate.OrderAggregate.FAILURE_MESSAGE_DELIMITER;

@Component
public class OrderDataAccessMapper {

    public OrderEntity orderToOrderEntity(OrderAggregate order) {
    ...
    public OrderAggregate orderEntityToOrder(OrderEntity orderEntity) {
